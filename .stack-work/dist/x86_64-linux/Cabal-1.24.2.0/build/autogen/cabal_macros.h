...
/* package haskellHtml-0.1.0.0 */
#define VERSION_haskellHtml "0.1.0.0"
#define MIN_VERSION_haskellHtml(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "haskellHtml-0.1.0.0-BECCdle20pIAvIPQ9BjiaC"

#define CURRENT_PACKAGE_KEY "haskellHtml-0.1.0.0-BECCdle20pIAvIPQ9BjiaC"
